...
if Train:
    ...
    # ENV_NAME_2 = "PandaCurriculum2-v2"
    ...
    # ENV_NAME_3 = "PandaCurriculum3-v2"
    ...
    # total_ac_loss = []
    # total_cr_loss = []
    # for epoch in range(MAX_EPOCHS_3):
    #     start_time = time.time()
    #     epoch_actor_loss = 0
    #     epoch_critic_loss = 0
    #     for cycle in range(0, MAX_CYCLES):
    ...
    #     plt.style.use('ggplot')
    #     plt.figure()
    #     plt.plot(np.arange(0, MAX_EPOCHS_3), t_success_rate)
    #     plt.title("Success rate")
    #     plt.savefig("success_rate_3.png")
