...
class TurtleBotV0Env(gym.Env):
	...
	def reset(self):
		...
		self.inventory = dict([('wood', self.starting_trees), ('stone', self.starting_rocks),('stone_axe',0)])
	...
	def get_observation(self):
		...
		lidar_readings.append(self.inventory['stone_axe'])
