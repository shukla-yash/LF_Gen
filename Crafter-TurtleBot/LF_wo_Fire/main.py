...
if __name__ == "__main__":
	...
	env = gym.make(env_id, map_width = 10, map_height = 10, items_quantity = {'tree': 1, 'rock': 0, 'crafting_table': 0, 'pogo_stick':0},
		initial_inventory = {'wall': 0, 'tree': 0, 'rock': 0, 'crafting_table': 0, 'pogo_stick':0}, goal_env = 0 )
